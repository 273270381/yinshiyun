package com.myezopen.myezopen.realplay;
...
import com.myezopen.myezopen.CameraListActivity;
import com.myezopen.myezopen.MyApplication;
import com.myezopen.myezopen.R;
import com.myezopen.myezopen.Utils.ActivityUtils;
import com.myezopen.myezopen.Utils.AudioPlayUtil;
import com.myezopen.myezopen.Utils.DataManager;
import com.myezopen.myezopen.Utils.EZUtils;
import com.myezopen.myezopen.Utils.VerifyCodeInput;
import com.myezopen.myezopen.Utils.WaitDialog;
import com.myezopen.myezopen.widget.LoadingTextView;
import com.myezopen.myezopen.widget.ScreenOrientationHelper;
...
//    private EZCameraInfo mCameraInfo = null;
    ...
    private ImageButton ptzZoonInBtn;
    private ImageButton ptzZoonOutBtn;
    private ImageButton ptzSpeedBtn;
    //隐私保护动画
...
//        client.disconnect();
    ...
    public void finish() {
        if (mCameraInfo != null){
            ...
            setResult(CameraListActivity.RESULT_CODE, intent);
        }
        super.finish();
    }
                ...
                case MotionEvent.ACTION_DOWN:
                    switch (view.getId()) {
                        ...
                        case R.id.ptz_zoomIn:
                            ptzZoonInBtn.setBackgroundResource(R.drawable.zoonin_sel);
                            ptzOption(EZPTZCommand.EZPTZCommandZoomIn,EZPTZAction.EZPTZActionSTART);
                            break;
                        case R.id.ptz_zoomOut:
                            ptzZoonOutBtn.setBackgroundResource(R.drawable.zoonout_sel);
                            ptzOption(EZPTZCommand.EZPTZCommandZoomOut,EZPTZAction.EZPTZActionSTART);
                            break;
                        case R.id.ptz_speed:
                            if (speed == EZConstants.PTZ_SPEED_DEFAULT){
                                ptzSpeedBtn.setBackgroundResource(R.drawable.fast_sel);
                                speed = EZConstants.PTZ_SPEED_FAST;
                            }else{
                                ptzSpeedBtn.setBackgroundResource(R.drawable.slow_sel);
                                speed = EZConstants.PTZ_SPEED_DEFAULT;
                            }
                            break;
                        default:
                            break;
                ...
                case MotionEvent.ACTION_UP:
                    switch (view.getId()) {
                        ...
                        case R.id.ptz_right_btn:
                            ...
                            break;
                        case R.id.ptz_zoomIn:
                            ptzZoonInBtn.setBackgroundResource(R.drawable.zoonin);
                            ptzOption(EZPTZCommand.EZPTZCommandZoomIn,EZPTZAction.EZPTZActionSTOP);
                            break;
                        case R.id.ptz_zoomOut:
                            ptzZoonOutBtn.setBackgroundResource(R.drawable.zoonout);
                            ptzOption(EZPTZCommand.EZPTZCommandZoomOut,EZPTZAction.EZPTZActionSTOP);
                            break;
                        case R.id.ptz_speed:
                            if (speed == EZConstants.PTZ_SPEED_DEFAULT){
                                ptzSpeedBtn.setBackgroundResource(R.drawable.slow);
                            }else{
                                ptzSpeedBtn.setBackgroundResource(R.drawable.fast);
                            }
                            break;
                        default:
                            break;
...
//        mTalkPopupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 0);
    ...
    private void openPtzPopupWindow(View parent) {
        ...
        ptzZoonInBtn= (ImageButton) layoutView.findViewById(R.id.ptz_zoomIn);
        ptzZoonInBtn.setOnTouchListener(mOnTouchListener);
        ptzZoonOutBtn = (ImageButton) layoutView.findViewById(R.id.ptz_zoomOut);
        ptzZoonOutBtn.setOnTouchListener(mOnTouchListener);
        ptzSpeedBtn = (ImageButton) layoutView.findViewById(R.id.ptz_speed);
        ptzSpeedBtn.setOnTouchListener(mOnTouchListener);
    ...
    private void onRecordBtnClick() {
        ...
        if (mEZPlayer != null) {
            ...
            String strRecordFile = Environment.getExternalStorageDirectory().getPath() + "/EZOpenSDK/CapturePicture/" + mDeviceInfo.getDeviceName()+"/"
    ...
    private void startRealPlay() {
        ...
        if (mCameraInfo != null) {
            ...
            mEZPlayer = MyApplication.getOpenSDK().createPlayerWithUrl(mRtspUrl);
